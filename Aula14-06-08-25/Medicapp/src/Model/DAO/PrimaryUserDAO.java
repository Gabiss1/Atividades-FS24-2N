...
public class PrimaryUserDAO {
    public void setUsers(PrimaryUser user, String type){
    ...
    public static void setCpfUser(PrimaryUser.NaturalPerson user){
        String sql = "INSERT INTO Natural_Person (User_Name, User_Email, User_Address, User_Contact, User_Birth_Date) VALUES (?, ?, ?, ?, ?)";
        Connection conexao = null;
        PreparedStatement stmt = null;
